...
class Heap {
    ...
    public:
        ...
        void insert(T element) {
            ...
            while (i>1) {
                heapIndex parent = this->getParentPosition(i);
                if (this->tree.at(i) < this->tree.at(parent)) {
                    std::swap(this->tree.at(i), this->tree.at(parent));
                    i = parent;
                } else {
                    break;
                }
        ...
        void remove(T value) {
            ...
            this->tree.at(pos) = this->tree.back();
            this->tree.pop_back();

            if (pos < this->tree.size()) {
                heapIndex parent = this->getParentPosition(pos);
                if (pos > 1 && this->tree.at(pos) < this->tree.at(parent)) {
                    while (pos > 1 && this->tree.at(pos) < this->tree.at(parent)) {
                        std::swap(this->tree.at(pos), this->tree.at(parent));
                        pos = parent;
                        parent = this->getParentPosition(pos);
                    }
                } else {
